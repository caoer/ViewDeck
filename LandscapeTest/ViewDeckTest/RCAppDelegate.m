...
//  ViewDeckTest
//
//  Created by Zitao Xiong on 5/22/13.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    IIViewDeckController *viewDeckVC = [[IIViewDeckController alloc] initWithCenterViewController:centerVC leftViewController:leftVC];
    viewDeckVC.navigationControllerBehavior = IIViewDeckNavigationControllerIntegrated;
